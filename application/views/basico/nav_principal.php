						...
						<li class="btn-toolbar navbar-form" role="toolbar" aria-label="...">
							...
							<div class="btn-group">
								...
								<ul class="dropdown-menu" role="menu">
									...
									<li><a href="<?php echo base_url() ?>relatorio/orcamento"><span class="glyphicon glyphicon-list"></span> Receitas Mensais</a></li>
									<li role="separator" class="divider"></li>
									<li><a href="<?php echo base_url() ?>relatorio/receitas"><span class="glyphicon glyphicon-list"></span> Receitas Gerais</a></li>							
									<li role="separator" class="divider"></li>
									...
									<li><a href="<?php echo base_url() ?>relatorio/despesas"><span class="glyphicon glyphicon-list"></span> Despesas Mensais</a></li>
									<li role="separator" class="divider"></li>
									<li><a href="<?php echo base_url() ?>relatorio/despesaspag"><span class="glyphicon glyphicon-list"></span> Despesas Gerais</a></li>							
									<li role="separator" class="divider"></li>
