        ...
        <div class="panel panel-<?php echo $panel; ?>">
			...
			<br>
                ...
                <div class="form-group">
                    <div class="row">
						...
						<div class="col-md-2">
							<label for="ValorVenda">Orç.Aprov?</label>
							<div class="radio">
			...
			<div <?php echo $collapse; ?> id="DadosComplementares">   
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <label for="ValorServVenda">Valor do Serviço:</label>
                            <div class="input-group" id="txtHint">
                                <span class="input-group-addon" id="basic-addon1">R$</span>
			...
			<div class="form-group">
				<div class="row">
					...
					<!--<div class="col-md-12 text-center">
						<button class="btn btn-danger" type="button" data-toggle="collapse" data-target="#DadosComplementares" aria-expanded="false" aria-controls="DadosComplementares">
							<span class="glyphicon glyphicon-menu-up"></span> Orçamento - Produtos e Serviços
						</button>
					</div>-->
			...
			<div <?php echo $collapse; ?> id="FormaPagamento">
					...
					<div class="form-group">
						<div class="row">
							...
							<div class="col-md-3">
								<label for="Data">Data do 1ºVenc.</label>
								<div class="input-group <?php echo $datepicker; ?>">
									<input type="text" class="form-control Date" <?php echo $readonly; ?> maxlength="10" placeholder="DD/MM/AAAA"
										   name="Data" value="<?php echo $query['Data']; ?>">
									<span class="input-group-addon" disabled>
			...
			</div> <!--Fim da função que esconde a tela FORMA DE PAGAMENTO-->
			...
			</div> <!--Fim da função que esconde a tela PROCEDIMENTOS-->
