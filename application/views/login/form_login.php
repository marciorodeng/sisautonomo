<div class="container text-center" id="login">
    ...
    <h2 class="form-signin-heading text-center">Atônomos</h2>	
    ...
    <br>
			...
			<a class="btn btn-lg btn-warning btn-block" href="<?php echo base_url(); ?>loginfuncionario/registrar" role="button">Cadastrar Novo Usuário</a>
			<br>
